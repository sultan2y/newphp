    ...
    <?php
        ...
        //editing components
            ?>
                ...
                 ~dulla^@204~ ~dulla^@204~ e { echo "<tr>";}
                  ~dulla^@204~          echo "<td>".$r['startt']."</~dulla^@204~ specialchars_decode($r['testname'],EN~dulla^@204~ td><td>".htmlspecialchars_decode($r['~dulla^@204~ UOTES)."</td><td>".$r['remainingtime'~dulla^@204~                                      ~dulla^@204~ ass=\"tddata\"><a title=\"Resume\" hr~dulla^@204~ st.php?resume=".$r['testid']."\"><img~dulla^@204~ /resume.png\" height=\"30\" width=\"6~dulla^@204~ ume\" /></a></td></tr>";
           ~dulla^@204~             }
         ...
         ~dulla^@204~           }
           ...
           <div id="f~dulla^@204~       <p style="font-size:70%;color:#~dulla^@204~ p;</p>
           </div>
      </div>
  </body>
</html>
