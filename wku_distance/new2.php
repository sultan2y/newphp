...
<td  bgcolor="white" valign="top" width=921px><br><center><h2>Delete Announcement</h2></center>
<!--------body  --->
	 <?php
...
print("<td align = 'center' width = '1'><a href = 'del.php?key=".$ctrl."'><img src = 'remove.png' border = '0' title='Delete' onclick='isdelete();'></img></a>
		</td>");
  print( "</tr>");
  }
print("</table>");
