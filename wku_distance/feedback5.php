...
function isAlphabet(elem, helperMsg){
	...
	<h1 align="center"<b>Comment Form</b></h1>
<form method="post" action="feedback5.php" name="aform" onsubmit='return formValidation()'>
     <table bgcolor=white valign="top" style="border:1px solid #336699;width:420px;height:250px;border-radius:15px;box-shadow:1px 8px 8px " align="center">
 <tr valign="top">
...
echo' <meta content="4;feedback5.php" http-equiv="refresh" />';
}
//mysql_close($conn)
?>
</td>
